...
## Post-#240 Re-Derivation (complete — 12/12 entries)
...
**Verdict diff** (generated by
`uv run python experiments/nash/scripts/diff_post240.py`; note the payoff
scales are not comparable across the pre/post columns — the post-#236
reward mechanics changed the payoff scale):

| Scenario | Pre-#240 (type, payoff, top) | Post-#240 (type, payoff, top) | Liar mass Δ |
|----------|------------------------------|-------------------------------|-------------|
| chain_reaction | pure, 2.94, Free Rider (1.00) | pure, 3373.27, Firefighter/Hero (1.00) | +0.000 |
| deceptive_calm | pure, 37.30, Coordinator (1.00) | pure, 3674.04, Firefighter/Hero (1.00) | +0.000 |
| default | pure, 60.30, Coordinator (1.00) | pure, 2268.53, Firefighter/Hero (1.00) | +0.000 |
| early_containment | mixed, 24.27, Free Rider (0.60) | pure, 2565.78, Firefighter/Hero (1.00) | +0.000 |
| easy | pure, 81.89, Free Rider (1.00) | pure, 1844.22, Free Rider (1.00) | +0.000 |
| greedy_neighbor | pure, 58.77, Coordinator (1.00) | pure, 3013.52, Firefighter/Hero (1.00) | +0.000 |
| hard | pure, -45.69, Free Rider (1.00) | mixed, -2396.56, Coordinator (0.97) | +0.000 |
| mixed_motivation | pure, 46.66, Coordinator (1.00) | pure, 3628.78, Firefighter/Hero (1.00) | +0.000 |
| overcrowding | pure, 17.79, Free Rider (1.00) | pure, 539.34, Firefighter/Hero (1.00) | +0.000 |
| rest_trap* | pure, 98.94, Coordinator (1.00) | mixed, 2009.22, Coordinator (0.42) | +0.000 |
| sparse_heroics | pure, 80.71, Coordinator (1.00) | pure, 3990.07, Firefighter/Hero (1.00) | +0.000 |
| trivial_cooperation | mixed, 108.78, Free Rider (0.93) | mixed, 1306.25, Free Rider (0.52) | +0.000 |

\* **`rest_trap` is NOT a converged equilibrium.** The symmetric Double
Oracle cycles on this scenario (issues #352, #445); the committed entry
is the final non-converged solve, annotated with a measured
exploitability lower bound of 407.50/episode and a pointer to the
canonical *asymmetric* NE (free_rider ×3 + firefighter, 2984.04/episode,
#355). See `experiments/nash/rest_trap_seeded_do/RESULTS.md`.
