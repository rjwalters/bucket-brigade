...
- Figure 2 source (per-cell heatmap): [`paper/anvil_pub.bb-workshop.11/figures/src/recalibrated_heatmap.py`](../paper/anvil_pub.bb-workshop.11/figures/src/recalibrated_heatmap.py)
- Published paper: [`paper/anvil_pub.bb-workshop.11/main.tex`](../paper/anvil_pub.bb-workshop.11/main.tex)
...
uv run --with matplotlib python \
    paper/anvil_pub.bb-workshop.11/figures/src/recalibrated_heatmap.py
```
...
[`paper/anvil_pub.bb-workshop.11/main.tex`](../paper/anvil_pub.bb-workshop.11/main.tex)
§4.
