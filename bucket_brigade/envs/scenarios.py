...
# Scenario Registry
# Contains only tested scenarios with experiment directories and research results

SCENARIO_REGISTRY = {
    # Basic scenarios for general testing
    "default": default_scenario,
    "easy": easy_scenario,
    "hard": hard_scenario,
    # Core research scenarios - all tested with Nash V1, Nash V2, and evolution
