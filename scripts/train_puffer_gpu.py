...
class PolicyNetwork(nn.Module):
    ...
    def get_action_and_value(self, x, action=None):
        """
        Get actions and values in a format compatible with batch processing.

        Args:
            x: Observations tensor [batch_size, obs_dim]
            action: Optional actions tensor [batch_size, num_action_dims] for computing log probs
