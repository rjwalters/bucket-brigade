...
import type { TeamPreset } from '../../data/dashboardPresets';
...
/**
 * Card listing team presets with a radio-style picker.
 *
 * Receives the team list, the selected id, and callbacks for selection and
 * "pick a random preset" so it stays free of dashboard-specific state.
 */
export const TeamSelector: React.FC<TeamSelectorProps> = React.memo(
  ({ teams, selectedId, onSelect, onRandom }) => {
    return (
