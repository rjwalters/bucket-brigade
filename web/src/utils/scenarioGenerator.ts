 ...
 * Parameters must match bucket_brigade/envs/scenarios_generated.py exactly
 */
...
export function generateScenario(
  ...
  return {
    ...
    reward_own_house_survives: template.parameters.reward_own_house_survives ?? 100,
    reward_other_house_survives: template.parameters.reward_other_house_survives ?? 50,
