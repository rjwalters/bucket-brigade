...
|---------|----------|--------------------------|---------------------------------|--------------|---------|---------|
| het_ppo | rest_trap | n/a | +4.962 ± 6.586 | escaped_trap | 20 ok | not_scored_degenerate_reference |
| ippo | rest_trap | n/a | +4.122 ± 7.950 | at_random | 20 ok | not_scored_degenerate_reference |
