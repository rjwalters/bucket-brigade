...
entropy vs `gap_closed_ne_mean` gives Spearman ρ = 0.007 (p = 0.97). All four aggregates are
...
does not survive correction for the 8 tests in this family (Bonferroni α = 0.0063), and spread was never the paper's primary
...
|---|---|---|---|---|---|---|
| 0.10 | 1.00 | 0.10, 0.50, 0.90 | 2.2327, 2.2327, 2.2327 | yes | -0.32, -0.11, -0.00 | 0.32 |
| 0.30 | 1.00 | 0.10, 0.50, 0.90 | 2.1211, 2.1211, 2.1211 | yes | 0.01, 0.37, 0.24 | 0.36 |
| 0.30 | 2.00 | 0.10, 0.50, 0.90 | 2.1211, 2.1211, 2.1211 | yes | 0.09, 0.02, 0.27 | 0.25 |
...
| 0.50 | 2.00 | 0.10, 0.50, 0.90 | 2.2296, 2.2296, 2.2296 | yes | 0.03, 0.03, 0.08 | 0.06 |
...
| 0.90 | 0.50 | 0.50, 0.90 | 2.3227, 2.3227 | yes | 0.16, 0.05 | 0.11 |
| 0.90 | 1.00 | 0.10, 0.50, 0.90 | 2.4010, 2.4010, 2.4010 | yes | 0.14, 0.09, 0.14 | 0.06 |
| 0.90 | 2.00 | 0.10, 0.50, 0.90 | 2.4010, 2.4010, 2.4010 | yes | 0.21, 0.12, 0.13 | 0.09 |

## Noise ceiling (n = 4 seeds)

`gap_closed_ne_mean` is estimated from n = [4] seeds per cell.
...
| b0.50_k0.10_c1.00 | 0.87 |
| b0.50_k0.30_c2.00 | 0.85 |
