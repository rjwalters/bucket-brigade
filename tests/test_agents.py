...
import numpy as np
import pytest
from bucket_brigade.agents import AgentBase, RandomAgent, HeuristicAgent, create_random_agent, create_archetype_agent
...
class TestHeuristicAgent:
    ...
    def test_action_generation(self):
        ...
        obs = {
            'signals': np.array([0, 1, 0, 1]),
            'locations': np.array([0, 1, 2, 3]),
            'houses': np.array([0, 1, 0, 0, 0, 0, 0, 1, 0, 0]),  # Houses 1 and 7 burning
            'last_actions': np.array([[0, 0], [1, 1], [2, 0], [3, 1]]),
            'scenario_info': np.array([0.25, 0.5, 100, 100, 0.5, 0.2, 12, 0.02, 12, 4])
        }
    ...
    def test_agent_memory(self):
        ...
        params = np.array([0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.9, 0.5, 0.5])  # High fatigue
        agent = HeuristicAgent(params, 0)
    ...
    def test_scenario_adaptation(self):
        ...
        params = np.array([0.5, 0.5, 0.5, 0.5, 0.8, 0.5, 0.5, 0.0, 0.5, 0.5])  # High risk aversion
        agent = HeuristicAgent(params, 0)
