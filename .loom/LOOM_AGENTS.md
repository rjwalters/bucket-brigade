...
> **📘 Important**: This document describes **Loom development agents** (Builder, Judge, Curator, etc.) that manage the software development workflow. These are NOT the game AI agents (Firefighter, Hero, Free Rider) - for those, see `docs/AGENT_ROSTER.md`.
